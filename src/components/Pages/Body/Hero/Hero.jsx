...
export default function Hero() {
    ...
    return (
        <div className="container flex w-96 items-center w-full bg-heroPattern bg-cover rounded-lg max-h-2/6 py-6 px-10 shadow-lg">
            ...
            <p className="text-white text-bold pl-4">{value < 50 ? `Hip Hop don't stop! ${current} of ${goal} habits so far` : `Kablam-O you have done ${current} of ${goal} habits so far`}</p>
        </div>
    );
}
